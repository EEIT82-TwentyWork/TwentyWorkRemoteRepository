...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
<%-- <script src="<%=request.getContextPath() %>/js/login/Main.js"></script> --%>
<%-- <script src="<%=request.getContextPath() %>/js/main/sketch.js"></script> --%>
<%-- <script src="<%=request.getContextPath() %>/js/main/navigation.js"></script> --%>
<%-- <script src="<%=request.getContextPath() %>/js/calendar/CheckTeamLeader.js"></script> --%>
</html>