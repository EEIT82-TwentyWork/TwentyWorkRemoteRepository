...
// 	呼叫fullCalendar
	$('#teamcalendarschedule').fullCalendar({ 
		theme: true,
		header: {
...
// 		}
	    ...
	    dayClick: function(datetime, allDay, jsEvent, view) {
	        ...
	        $.fancybox({//燈箱彈出
	         'type':'ajax', 
	         'href':'teamevent.jsp?startdate='+newdate
	     	}); 
	    },
	    ...
	    eventClick: function(calEvent, jsEvent, view) {
	        ...
	        $.fancybox({//燈箱彈出
		         'type':'ajax', 
		         'href':'teamevent.jsp?title='+eventTitle+'&startdate='+startdate+'&starttime='+starttime+'&enddate='+enddate+'&endtime='+endtime+'&allday='+eventAllday+'&id='+id+'&eventDesp='+eventDesp+'&location='+location+'&rminderdate='+rminderdate+'&rmindertime='+rmindertime+'&color='+eventcolor
		     	}); 
	    }
