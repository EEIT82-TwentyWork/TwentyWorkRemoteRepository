...
//				  console.log(product.favTitle)
				  $("#myFavLeftList>ul").append("<li id='leftList"+product.boardId+"'><div><img  src = 'images/board/star129_yellow.png'></div><a href='/TwentyWork/Board/"+product.boardId+"'>"+product.favTitle+"</a></li>")
