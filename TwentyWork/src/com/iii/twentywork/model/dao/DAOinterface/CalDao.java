...
public interface CalDao {
	...
	public abstract List<MySchedule> select();

	public abstract MySchedule insert(MySchedule bean);

	public abstract MySchedule update(String title, java.util.Date start,
			java.util.Date end, String myEventDesp, String myLocation, java.util.Date myRminder, String allday, String color, String id);
